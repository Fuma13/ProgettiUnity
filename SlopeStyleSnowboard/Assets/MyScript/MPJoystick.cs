...
public class MPJoystick : MonoBehaviour
{
	...
	public bool moveJoystick;							//lock or unlock movement of joystick
	private Rect r;										//finger position
    ...
    void Update()
    {
        ...
        if (!touchPad)
        {
            ...
            position.x = (r.x + guiTouchOffset.x - guiCenter.x) / guiTouchOffset.x;
            position.y = (r.y + guiTouchOffset.y - guiCenter.y) / guiTouchOffset.y;
        }
